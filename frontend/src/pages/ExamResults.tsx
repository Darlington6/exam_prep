...
export function ExamResults() {
  ...
  const handleRetakeExam = () => navigate(`/exam/${examId}`);
  const handleBackToCategories = () => navigate('/exams/categories');
  ...
  return (
    <div className="exam-results-page">
      <Navbar backTo="/exams/categories" backLabel="Categories" />
                    ...
                    <div className="review-options">
                      {question.options.map((option, optIndex) => {
                        ...
                        return (
                          <div
                            key={optIndex}
                            className={`review-option ${isCorrectOption ? 'correct-answer' : ''} ${
